...
# Дополнение: Таблица роста прибыли по странам
...
profit_by_country_year['profit_growth_pct'] = profit_by_country_year.groupby('country')['grosssalesamount'].pct_change() * 100
...
pivot_data = profit_by_country_2018_2019.pivot(index='country', columns='year', values='grosssalesamount').reset_index()
...
fig_growth = px.pie(filtered_growth, 
                    ...
                    title="Прирост с 2018 по 2019 для стран", 
                    labels={'growth_percentage': 'Прирост (%)', 'country': 'Страна'})
